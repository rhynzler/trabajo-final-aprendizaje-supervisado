...
A partir de las columnas anteriores, se ha seleccionado las siguientes columnas que van en dirección al objetivo de este trabajo: **instr, Q13-Q28**. La primera columna servirá como etiqueta de nuestro modelo de clusterización. Las preguntas desde la 13 hasta la 28 se centran en aspectos clave de la enseñanza del docente como conocimiento, preparación, comprensión, fluidez de enseñanza, participación, forma de evaluar a los estudiantes. Las preguntas permiten una evaluación integra de la calidad de la enseñanza y facilita la identificación de patrones en la percepción estudiantil, lo cual es fundamental para la implementación efectiva del modelo de clusterización.
